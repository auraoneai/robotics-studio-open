...
const RO_DATASETS = [
  {
    ...
    color: 'ok',
    current: true,
    path: '~/datasets/so101_kitchen_v3',
    embodiment: 'SO-101',
    task: 'Pick the apple',
    output: '~/robostudio/probes/so101',
  },
  {
    id: 'sim_rollout_policy_b',
    ...
    qaFlags: 18,
    color: 'ok',
    path: '~/datasets/sim_rollout_policy_b',
    embodiment: 'RoboMimic',
    task: 'Sort blocks',
    output: '~/robostudio/probes/sim_rollout',
  },
  {
    id: 'aloha_bin_pick_hdf5',
    ...
    qaFlags: 24,
    color: 'warn',
    path: '~/datasets/aloha_bin_pick_hdf5',
    embodiment: 'ALOHA',
    task: 'Bin pick',
    output: '~/robostudio/probes/aloha_bin_pick',
  },
];
