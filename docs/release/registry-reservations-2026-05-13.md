...
|---|---|---|---|
| GitHub | `auraoneai/robotics-studio-open` | Reserved and configured | Created via `gh repo create` on 2026-05-13. Scaffold pushed to `main` at `44ce1af`; labels and branch protection applied; evidence PR opened at `https://github.com/auraoneai/robotics-studio-open/pull/1`. |
